...
SRCS =	main.c parse.c parse_utils.c parse_utils2.c init.c print.c check.c window.c keyhook.c startwin.c calc_ray_utils.c put_wall_utils.c justfortesting.c
OBJ_DIR = object/
